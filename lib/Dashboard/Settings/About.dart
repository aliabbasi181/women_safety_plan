...
class AboutUs extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          AboutCard(
            asset: "cui",
            desc: """@Kanwal Tanveer, @Fatima, @Mahnoor, @Wadood Jamal, @Shahzaneer, @Zuwanish, @Aftab, @M. Hamza, @Hassam Talha""",
  ...
  showLicences(context) {
    showAboutDialog(
        ...
        applicationLegalese: "GDSC CUI is providing with a solution to female’s problems, an entirely userfriendly app and a need of the hour, aiming to connect you to the ones who care for you!");
  }
}
