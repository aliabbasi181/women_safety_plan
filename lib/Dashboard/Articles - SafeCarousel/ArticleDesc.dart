    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          ArticleImage(imageStr: "https://www.unwomen.org/-/media/headquarters/images/sections/news/stories/2017/11/fiji_varanisesemaisamoa_rakirakimarket_1_675pxwide.jpg?la=en&vs=1317"),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: Text(articles[0][0]),
          ),
          ArticleImage(imageStr: "https://www.unwomen.org/-/media/headquarters/images/sections/news/stories/2018/8/tanzania_daressalaam_bettyjaphet-mtewelle_mchikinimarketvendor_august2018_002_1_960x640.jpg?la=en&vs=4847"),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
