                        ...
                        child: Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 15),
                                Text("Currently Running...", style: TextStyle(color: Colors.red, fontSize: 10)),
                              ],
                            )),
                      ),
                    ],
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: Color(0xFFF5F4F6)),
                      child: SwitchListTile(
                        secondary: Lottie.asset("assets/routes.json"),
                        value: getHomeActivated,
                        onChanged: (val) async {
                          if (val && selectedContact == -1) {
                            Fluttertoast.showToast(msg: "Please select one contact!");
                            return;
                          }
                          setModalState(() {
                          ...
                          if (getHomeActivated) {
                            ...
                            Workmanager().registerPeriodicTask(
                              ...
                              "simplePeriodicTask",
                              tag: "3",
                              inputData: {"contact": numbers[selectedContact].split("***")[1]},
                        ...
                        subtitle: Text("Your location will be shared with one of your contacts every 15 minutes"),
                      ),
                    ),
                    Expanded(
                        child: FutureBuilder(
                            ...
                            builder: (context, AsyncSnapshot<List<String>> snapshot) {
                              if (snapshot.hasData && snapshot.data != null) {
                                ...
                                return ListTile(
                                  ...
                                  subtitle: Text("Please add atleast one Contact"),
