    ...
    return Scaffold(
      ...
      floatingActionButton: currentPage == 1
          ? FloatingActionButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => PhoneBook()));
              },
              child: Image.asset(
  ...
  sendAlertSMS(bool isAlert) async {
    ...
    try {
      ...
      if (numbers.isEmpty) {
        ...
        String li = "http://maps.google.com/?q=${currentLocation.latitude},${currentLocation.longitude}";
        if (isAlert) {
          link = "Help Me! SOS \n$li";
        } else {
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Pinput(
                    length: 4,
                    onSubmitted: (value) => _showSnackBar(value, context, userPin),
